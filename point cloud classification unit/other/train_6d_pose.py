...
CLASS_SIZE = 2  # Class size
BATCH_SIZE = 5 * CLASS_SIZE  # Batch size
ITERS = 60000 * CLASS_SIZE # How many generator iterations to train for

Learning_Rate = 5e-4  
decay_rate = 0.85  
decay_steps = 3000 * CLASS_SIZE 
...
gen_trans_train_op = tf.train.AdamOptimizer(learning_rate=learning_rate, beta1=0., beta2=0.9).minimize(trans_loss, global_step=global_step)
gen_rot_train_op = tf.train.AdamOptimizer(learning_rate=learning_rate, beta1=0., beta2=0.9).minimize(rot_loss, global_step=global_step)
gen_rot_plus_train_op = tf.train.AdamOptimizer(learning_rate=learning_rate, beta1=0., beta2=0.9).minimize(rot_plus_loss, global_step=global_step)
